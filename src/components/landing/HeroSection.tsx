        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="flex flex-col space-y-10">
            <div className="space-y-6">
              {/* Category eyebrow — defines what "it" is for a cold visitor */}
              <p
                className="text-xs sm:text-sm font-semibold uppercase tracking-[0.18em] text-primary/90 opacity-0 animate-fade-in"
                style={{ animationDelay: '150ms' }}
              >
                AI content in your real voice
              </p>
              {/* Headline */}
              <h1
              ...
              >
                EchoMe learns from your videos, posts, and emails — then turns any idea into posts, carousels, clips, and scripts that sound like you, ready for every platform.
              </p>
            </div>
