    ...
    <div className="min-h-screen bg-bg-primary">
      ...
      <div className="max-w-3xl mx-auto px-4 py-12 sm:py-16">
        ...
        <section className="text-center py-8">
          ...
          <a href="/app/content-kits" className="inline-flex items-center gap-2 px-6 py-3 bg-accent text-white rounded-xl font-semibold hover:bg-accent/90 transition-colors">Go to Content Kits</a>
