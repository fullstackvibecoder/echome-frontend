            ...
            <div className="space-y-4">
              <div className="pl-4 border-l-2 border-accent">
                ...
                <p className="text-stone-700 text-sm">
                  Sign up with your email or Google account. Your first 5 generations are free, no credit card required.
                </p>
              </div>
              <div className="pl-4 border-l-2 border-accent">
                <h3 className="text-base font-medium text-stone-800 mb-1">
          ...
          <div className="bg-white rounded-2xl border border-stone-200 p-6 md:p-8">
            ...
            <div className="space-y-4">
              <div>
                ...
                <p className="text-stone-700 text-sm">
                  Includes 5 free generations with voice matching, 1 platform per generation, and standard templates. No credit card required.
                </p>
              </div>
              <div>
