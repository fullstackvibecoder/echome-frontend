...
const faqCategories = [
  {
    ...
    questions: [
      ...
      },
      {
        ...
        a: 'Sign up with your email or Google account, then choose one of three input methods: upload a video file, paste a YouTube link, or use Quick Create to type or speak your idea. EchoMe processes your input and generates a complete Content Kit with clips, social posts, and carousels. Your first 2 generations are free — no credit card required.',
      },
      {
      ...
      },
      {
        ...
        a: 'Yes. EchoMe includes a free plan with 2 free generations, voice matching, 1 platform per generation, and standard templates. No credit card is required to get started. Paid plans start at $29/month for more processing hours, clips, and features.',
      },
    ],
  },
  {
    ...
    questions: [
      {
        ...
        a: 'EchoMe offers a free plan (2 generations, no credit card required), Echo ($29/mo), Echo Studio ($49/mo), and Echo Pro ($99/mo). Paid plans offer increasing processing hours, clips per video, Knowledge Base slots, export quality, and Creator Library access. Team plans are available starting at $129/mo for agencies managing multiple voices.',
      },
      {
